...
LATEST_CHANGES = [
    ...
    "v0.10.0: główne piętra Krypty, Mitycznej Krypty, Wieży Astralnej, Mitycznej Wieży i Twierdzy Gigantów dostały wielopokojowe mapy; v0.80.0 zwiększa je do 30 pomieszczeń na piętro.",
    ...
    "v0.10.0: Zatopiona Grota, Pradawny Las, Ogród Alchemika i Kopalnia Kryształów dostały wielopokojowe poziomy; v0.80.0 zwiększa je do 20 pomieszczeń na poziom.",
