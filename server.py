# -*- coding: utf-8 -*-
#!/usr/bin/env python3
"""Soulbound v0.71.3 Hourly Quest Diversity & Reward Hotfix."""
...
if os.environ.get("SOULBOUND_FULL_AUDIT", "").strip().lower() in ("1", "true", "yes", "on"):
    ...
    if FULL_GAME_PREDEPLOY_AUDIT_V0336["error_count"]:
        raise RuntimeError(
            "Full Game Pre-Deploy Audit v0.71.3 failed: "
...
# v0.71.3: compact only after the complete runtime and optional full audit are valid.
