...
_catalog_mut.catalog_update_path('MOB_TEMPLATES', MOB_TEMPLATES, (), _MACHINE_MOBS)

# Entry from the artisan district.
_catalog_mut.catalog_setdefault_path('ROOMS', ROOMS, (), "artisan_lane", {}).setdefault("exits", {})["northeast"] = "magitek_gate"
_machine_rooms = {
...
for _rid, (_name, _desc, _exits) in _machine_rooms.items():
    _catalog_mut.catalog_assign({"zone": MACHINE_ZONE, "name": _name, "desc": _desc, "exits": dict(_exits), "generator_level": 120}, 'ROOMS', ROOMS, (_rid,))
