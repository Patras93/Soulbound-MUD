...
from world.machine_expansion import _machine_template
...
_catalog_mut.catalog_setdefault_path('ROOMS', ROOMS, (), "magitek_omega_chamber", {}).setdefault("exits", {})["down"] = "magitek_sector1_lift"
...
for _rid,(_name,_desc,_exits,_lvl) in _v0319_rooms.items():
    _catalog_mut.catalog_assign({"zone":MAGITEK_DUNGEON_ZONE,"name":_name,"desc":_desc,"exits":dict(_exits),"generator_level":_lvl}, 'ROOMS', ROOMS, (_rid,))
...
_catalog_mut.catalog_update_path('MOB_TEMPLATES', MOB_TEMPLATES, (), _v0319_mobs)
